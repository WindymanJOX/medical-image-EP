function learn_explanatoryGraph()
...
% mex ./tool/main/getProb_local_mex.cpp -output getProb_local_mex -g
% mex ./tool/main/getOtherProb.cpp -output getOtherProb -g
load(['./mat/',netname,'/roughCNN.mat'],'batch_f','batch_f_flip','conf');
